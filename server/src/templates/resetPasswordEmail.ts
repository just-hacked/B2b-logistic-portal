...
<head>
  ...
  <title>Reset your Elios password</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          <!-- Header -->
          <tr>
            <td style="background:#4A3B52;padding:32px 40px;text-align:center;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 28px;color:#374151;font-size:15px;line-height:1.6;">
                We received a request to reset your Elios Wholesale password. Click the button below to set a new one.
              </p>
              <!-- CTA Button -->
              <table cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
                <tr>
                  <td align="center" style="border-radius:8px;background:#4A3B52;">
                    <a href="${resetUrl}"
              ...
              <p style="margin:0 0 28px;word-break:break-all;">
                <a href="${resetUrl}" style="color:#4A3B52;font-size:13px;">${resetUrl}</a>
              </p>
